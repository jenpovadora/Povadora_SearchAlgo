...
namespace AISearchSample
{
    ...
    class Search
    {
        ...
        public Search(ArrayList nodes, SearchType type) 
        {
           // type DFS = use a stack-based fringe (Fringe2)
           if (type == SearchType.DFS) // DFS
               fringe = new Fringe2();
           // type BFS = use a queue-based fringe (Fringe)
           if (type == SearchType.BFS) // BFS
               fringe = new Fringe();
            n = nodes;
